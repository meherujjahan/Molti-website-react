    ...
    return (
        <div className='container'>
           ...
           <div className='blog-card'>
                ...
                <div className='blog-card-text'>
                    <h4> <b>Adipiscing vitae proin sagittis nisl rhoncus mattis <br />Adipiscing vitae proin sagittis nisl rhoncus <br /> mattis </b></p>
                </div>
           ...
           <div className='blog-card'>
                ...
                <div className='blog-card-text'>
                    <h4> <b>Dictum fusce ut placerat orci nulla pellentesque <br />Dictum fusce ut placerat orci nulla <br /> pellentesque</p>
                </div>
