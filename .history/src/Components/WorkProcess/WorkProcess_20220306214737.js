...
const WorkProcess = () => {
    return (
        <div className='work-process'>
            ...
            <div>
                <h4>Strategy</h4>
               <span> <p>Your content goes here. Edit or remove <br /> this text inline or in the module Content <br /> settings. You can also style every aspect <br /> of this content in the module Design <br /> settings.</p></span>
