        ...
        <div className='container'>
           ...
           <div className='blog-card'>
                <div>
                    ...
                    <div  className='date-btn'><button>Dec 22</button></div>
                </div>
           ...
           <div className='blog-card'>
                <div>
                    <img src={image2} alt="" />
                    <div className='img-btn'> <button>WEBSITE</button></div>
                    <div  className='date-btn'><button>Dec 22</button></div>
                </div>
           ...
           <div className='blog-card'>
                <div>
                    <img src={image3} alt="" />
                    <div className='img-btn'> <button>FEATURE</button> <button>WEBSITE</button></div>
                    <div  className='date-btn'><button>Dec 22</button></div>
                </div>
               
            
                <div className='blog-card-text'>
                    <h4> <b>Dictum fusce ut <br /> placerat orci nulla <br /> pellentesque</b></h4>
                    <p>Lorem ipsum dolor sit amet, <br /> consectetur adipiscing elit, sed do <br /> eiusmod tempor incididunt ut labore et dolore magna...</p>
                </div>
